var getMonthName = function(t) {
	...
	handleScheduleCalendar = function() {
		var t = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"],
			...
			o = r.getFullYear(),
			a = [
				["2/" + n + "/" + o, "Popover Title", "#", COLOR_GREEN, "Some contents here"],
				["5/" + n + "/" + o, "Tooltip with link", "http://www.seantheme.com/", COLOR_GREEN],
				["18/" + n + "/" + o, "Popover with HTML Content", "#", COLOR_BLACK, 'Some contents here <div class="text-right"><a href="http://www.google.com">view more >>></a></div>'],
				["28/" + n + "/" + o, "Color Admin V1.3 Launched", "http://www.seantheme.com/color-admin-v1.3", COLOR_BLACK]
			],
			i = $("#schedule-calendar");
		$(i).calendar({
			months: t,
	...
	DashboardV2 = function() {
		...
		return {
			init: function() {
				handleVisitorsDonutChart(), handleVisitorsVectorMap()
			}
		}
	}();
