...
<body class="pace-top">
                        ...
                        <div class="row mt-4">
                            <div class="col-md-4 form-group">
                                ...
                                <select name="SchoolType" id="SchoolType" class="form-control" required>
                                    ...
                                    <?php foreach ($scltypes as $type){  if($type->shortname != 'GB' && $type->shortname != 'GSB'){ ?>
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <select name="StateName" id="StateName" class="form-control select2" required>
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <select name="CityName" id="CityName" class="form-control select2" required>
    ...
    $(document).ready(function() {
        ...
        $("#registerAccount").click(function(event) {
           ...
           // alert('school type :' +scltype + 'FirstName :' + fname + 'LastName :' + lastname + 'Mail :' + mailid + 'Mobile :' + mobile + 'Address :' + address + 'County :' + country + 'state :' + stateid + 'City :' + citydist + 'Pincode :' + pincode );
