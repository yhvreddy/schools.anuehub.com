    ...
    <div class="login login-v2" data-pageload-addclass="animated fadeIn">
        ...
        <div class="login-header">
            <div class="brand">
                ...
                <small>Change 4-digits pin..!</small>
            </div>
            <div class="icon">
        ...
        <div class="login-content">
            <form action="<?= base_url('users/savenewchangepin') ?>" method="POST" class="margin-bottom-0">
                ...
                <div class="form-group m-b-20">
                    <input type="password" class="form-control form-control-lg" placeholder="Enter New 4-digits Pin" required  id="new_password" maxlength="4" name="new_pin" autofocus="autofocus" value="">
                </div>

                <div class="form-group m-b-20">
                    <input type="password" maxlength="4" class="form-control form-control-lg" placeholder="Enter confirm 4-digits Pin" required  id="confirm_pin" name="confirm_pin" autofocus="autofocus" value="">
                </div>

                <div class="login-buttons">
                    <button type="submit" class="btn btn-success btn-block btn-lg">Change 4-digits pin</button>
                </div>
