								...
								<?php $i = 1; foreach($resultslist as $timings){
									...
									<tr class="text-uppercase">
										...
										<td align="center">
											...
											<a href="<?=base_url('dashboard/exam/deleteresultlist/'.$timings->sno.'/'.$timings->branch_id.'/'.$timings->school_id)?>" onclick="return confirm('Are you want to delete <?=$studentslist[0]->firstname.' - '.$slab[0]->slab_name?> Result List..?');"><i class="fa fa-trash-o fa-dx"></i></a>&nbsp;
										</td>
									</tr>
								<?php } ?>
								</tbody>
