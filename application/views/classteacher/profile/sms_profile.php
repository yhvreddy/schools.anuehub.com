		...
		<div class="profile-header">
			...
			<div class="profile-header-content">
				...
				<div class="profile-header-info">
					...
					<p class="m-b-10"> &nbsp;<i class="fa fa-user"></i> : <?=ucwords($userdetails->employeetype.' - '.$userdetails->emoloyeeposition)?></p>
				...
				<div class="row">
							...
							<div class="panel-body">
								...
								<div class="row mt-3">
									<div class="col-md-12">
										...
										<label> Designation :</label> <span class="text-capitalize"><?=$userdetails->designation?></span><br>
										<label> Position :</label> <span class="text-capitalize"><?=$userdetails->emoloyeeposition?></span><br>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="col-8">
						<div class="panel panel-inverse">
							...
							<div class="panel-body">
								<form method="post" class="col-12" action="<?= base_url('classteacher/profile/updateprofiledata/'.$userdetails->sno) ?>" enctype="multipart/form-data">
									...
									<div class="row">
										...
										<div class="col-xs-12 col-sm-6 col-md-3">
											...
											<div class="form-group">
												<input type="tel" class="form-control mobile-phone-number" placeholder="Enter Alter Number" name="empphone" maxlength="13" value="<?=$userdetails->phone?>">
											</div>
										</div>
										...
										<div class="col-xs-12 col-sm-6 col-md-3">
											...
											<div class="form-group">
												<input type="text" id="mdate" class="form-control mydatepicker" placeholder="Please choose a date..." value="<?=$userdetails->dob?>" name="empdob" required>
											</div>
										</div>
						...
						<div class="panel panel-inverse">
							...
							<div class="panel-body">
								<div class="row">
									...
									<form method="post" class="col-12" action="<?= base_url('classteacher/profile/updatepassword/'.$userdetails->sno) ?>">
										<input type="hidden" name="reg_id" value="<?=$userdetails->id_num?>">
										<input type="hidden" name="id" value="<?=$userdetails->sno?>">
										<div class="row">
											<div class="col-md-4 form-group">
