...
<div id="content" class="content">
    ...
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Notice Details<small></small></h1>
    <!-- end page-header -->
    <!-- Start Page Content -->
    <div class="row">
        <div class="col-12">
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    <div class="panel-heading-btn">
                        <a href="<?=base_url('classteacher/notices')?>" class="pull-right btn btn-success btn-xs"><i class="fa fa-list"></i> Notice List</a>
                                ...
                                <li class="media media-sm clearfix">
                                    ...
                                    <div class="media-body">
                                        <div class="email-from text-inverse f-s-14 f-w-600 m-b-3">
                                            Notice To :
                                            <?php $noticeto = explode(',',$notice->notice_to);
