            ...
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    <div class="panel-heading-btn">
						<?php $popup = base_url('dashboard/timings/set_timings?sutype=class'); ?>
						<!--
							onclick='window.open("<?php //$popup ?>", "mywindow", "scrollbars=no,resizable=no,status=no,location=no,toolbar=no,menubar=no,width=800,height=500,left=100,top=100");'
						-->
						<a href="<?=$popup?>" class="btn btn-success btn-xs"  data-backdrop="static" data-keyboard="false" class="font-20"><i class="fa fa-clock"></i>  Add / Update Class Timings</a>
                    </div>
