            ...
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    <div class="panel-heading-btn">
                        <a href="<?=base_url('classteacher/attendence/attendencelist')?>" class="pull-right btn btn-success btn-xs"><i class="fa fa-list"></i> Attendance List</a>
                ...
                <div class="panel-body">
					<?php //print_r($userdata->employee_syllabus); ?>
                    <div class="col-md-12">
                        <form class="row" method="post" action="#" id="myattendence">
                            ...
                            <div class="form-group col-md-3 col-lg-3 col-sm-6">
                                ...
                                <select required class="form-control select2" disabled id="attendenceType">
                                    <option value="">Select Attendence type</option>
                                    <option selected value="std">Student Attendence</option>
                            ...
                            <div class="col-md-5 form-group" id="stdclass">
                                <div class="row">
                                    <div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                        ...
                                        <select type="text" required  disabled name="StdSyllubas" id="sclsyllubaslist" class="form-control select2">
                                            <option value="">Select Syllabus Type</option>
                                            <?php foreach ($syllabus as $key => $value) { ?>
                                                <option <?php if($userdata->employee_syllabus == $key){ echo 'selected'; } ?> value="<?= $key ?>"><?= $value ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                        ...
                                        <?php
										$dataclass = $this->Model_integrate->classeslist($userdata->school_id,$userdata->branch_id,$userdata->employee_syllabus);
										//print_r($dataclass);
										?>
										<select type="text" name="StdClass" id="SyllabusClasses" class="form-control select2" disabled="" style="padding:0px 10px">
                                            <option value="">Select Class</option>
											<?php foreach ($dataclass as $data){ ?>
												<option <?php if($data == $userdata->employeeclass){ echo 'selected'; } ?> value="<?=$data?>"><?=$data?> Class</option>
											<?php } ?>
                                        </select>
                                    </div>
                                </div>
