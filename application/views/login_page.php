    ...
    <div id="page-container" class="fade">
        ...
        <div class="login login-v2" data-pageload-addclass="animated fadeIn">
            ...
            <div class="login-content">
                <form action="<?= base_url('user/loginAccess') ?>" method="POST" class="margin-bottom-0" autocomplete="on">
                    <div class="form-group m-b-20">
                        <input type="text" class="form-control form-control-lg" placeholder="Email Address" required  id="userName" name="userName" autocomplete="off" autofocus="autofocus" value="">
                    </div>
                    <div class="form-group m-b-20">
                        <input type="password" class="form-control form-control-lg" placeholder="Password" required name="passWord" required id="passWord" autocomplete="off" value="">
                    </div>
                    ...
                    <div class="m-t-20">
						<span class="pull-left">Forget Password..? <a href="<?=base_url('users/forgetpassword')?>"> Click here </a></span>
						<span class="pull-right">Forget 4 digits pin  <a href="<?=base_url('users/forgetpin')?>"> Click here</a>.!</span>
                    </div>
                </form>
            </div>
            <!-- end login-content -->
