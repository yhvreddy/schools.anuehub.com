					...
					<div class="vertical-box-cell">
						...
						<div class="vertical-box-inner-cell">
							...
							<div data-scrollbar="true" data-height="100%" class="p-15">
								<!-- begin email form -->
								<form action="<?=base_url('user/mail/savecomposemail')?>" method="POST" enctype="multipart/form-data" name="email_to_form">
									<!-- begin email to -->
...
<!--											</span>-->
										<input type="text" id="tags_1" required="required" class="form-control" name="mail_to">
									</div>
									...
									<div class="col-md-12 compose_footer">
										...
										<span class="pull-right">
											...
											<button type="submit" class="btn btn-primary p-l-40 p-r-40"><i class="far fa-envelope"></i> Send Mail</button>
										</span>
									</div>
									<!-- end wrapper -->
								</form>
