		...
		<div class="vertical-box-column bg-white">
			...
			<div class="vertical-box">
				...
				<?php if(count($mailsents) > 0){ ?>
					...
					<div class="wrapper bg-silver-lighter">
						...
						<div class="btn-toolbar">
							...
							<div class="btn-group">
								...
								<button class="btn btn-sm btn-white" id="ImportantInboxMails" data-email-action="important"><i class="fa t-plus-1 fa-flag f-s-14 m-r-3"></i> <span class="hidden-xs">Important</span></button>
							</div>
							<!-- end btn-group -->
							<!-- begin btn-group -->
							<div class="btn-group m-r-5">
								<a href="<?=base_url('user/mail/inbox')?>" style="margin: 0px;padding: 0px 5px 2px 5px;font-size: smaller;" class="btn btn-xs btn-white pt-1" id="RefreshInboxData"><i class="fa fa-redo t-plus-1"></i> Refresh Inbox</a>
							</div>
							<!-- end btn-group -->
							<!-- begin btn-group -->
							<div class="btn-group ml-auto">
								<label class="mb-0" style="font-size: 18px;"><i class="fa fa-inbox"></i> Inbox</label>
							</div>
							<!-- end btn-group -->
						</div>
						<!-- end btn-toolbar -->
					...
					<div class="vertical-box-row" id="#MailInboxData">
								...
								<div data-scrollbar="true" data-height="100%">
									...
									<ul class="list-group list-group-lg no-radius list-email">
										<?php $i = 1; foreach ($mailsents as $mailsent){
											...
											?>
											<li class="list-group-item" <?php if($mailsent->mail_read == 0){ ?> style="background-color: #e5f6ffb5" <?php } ?>>
					...
					<script>
						/*$(document).ready(function(){
							function InboxData(){
								$.get("<?php //base_url('user/mail/inboxajaxdata')?>", function(data, status){
									//alert("Data: " + data + "\nStatus: " + status);
									$("#MailInboxData").html(data);
								});
							}
							InboxData();
							$("#RefreshInboxData").click(function () {
