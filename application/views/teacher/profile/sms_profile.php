				...
				<div class="row">
					...
					<div class="col-8">
						<div class="panel panel-inverse">
							...
							<div class="panel-body">
								<form method="post" class="col-12" action="<?= base_url('teacher/profile/updateprofiledata/'.$userdetails->sno) ?>" enctype="multipart/form-data">
						...
						<div class="panel panel-inverse">
							...
							<div class="panel-body">
								<div class="row">
									...
									<form method="post" class="col-12" action="<?= base_url('teacher/profile/updatepassword/'.$userdetails->sno) ?>">
										<input type="hidden" name="reg_id" value="<?=$userdetails->id_num?>">
										<input type="hidden" name="id" value="<?=$userdetails->sno?>">
										<div class="row">
											<div class="col-md-4 form-group">
