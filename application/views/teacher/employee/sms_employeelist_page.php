                            ...
                            <tbody>
                                <?php $i=1; foreach ($employees as $employee) { ?>
                                    <tr>
                                        ...
                                        <td><a href="<?=base_url('teacher/employee/details/'.$employee->sno.'/'.$employee->branch_id.'/'.$employee->school_id)?>"> <?=$employee->id_num?></a></td>
                                        ...
                                        <td align="center">
                                            <span data-toggle="tooltip" title="View details"><a href="<?=base_url('teacher/employee/details/'.$employee->sno.'/'.$employee->branch_id.'/'.$employee->school_id)?>" data-toggle='tooltip' title="View" class="font-20"><i class="fa fa-file fa-dx"></i></a></span>&nbsp;&nbsp;
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
