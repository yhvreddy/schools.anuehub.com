        ...
        <div class="col-12">
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    ...
                    <form class="row" method="post" id="exportdatabackup">
                        ...
                        <div class="form-group col-md-3" id="all_session">
                        ...
                        <div class="form-group col-md-3" id="dmy_session">
                        ...
                        <div class="form-group col-md-2" id="gender_session">
                            <label for="selected_gender">Select Gender <span class="text-danger">*</span></label>
                            <select class="form-control" name="selected_gender" id="selected_gender" style="padding: 0px;">
                        ...
                        <div class="form-group col-md-4" id="syllabus_session">
                            <div class="row">
                                <div class="col-md-6">
                        ...
                        <div class="form-group col-md-4" id="date_session">
                            <div class="row">
                                <div class="col-md-6">
                        ...
                        <div class="form-group col-md-4" id="month_session">
                            <div class="row">
                                <div class="col-md-6">
                        ...
                        <div class="form-group col-md-4" id="year_session">
                            <div class="row">
                                <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-12 table-responsive" id="exportingData">
...
<script type="text/javascript">
    $(document).ready(function($) {
        ...
        $("#from_date").attr("placeholder", "Pick from date");
        $("#to_date").attr("placeholder", "Pick to date");
        $("#from_month").attr("placeholder", "Pick from month");
        $("#to_month").attr("placeholder", "Pick to month");
        $("#from_year").attr("placeholder", "Pick from year");
        $("#to_year").attr("placeholder", "Pick to year");
        
        //step - 1
        $("#export_type").change(function(){
            var export_type =   $(this).val();
            
            $("#export_sort_session").select2({ placeholder: '--- Select sort by ---' });
            $("#selected_gender").select2({ placeholder: '--- Select gender ---' });
            $("#sclsyllubaslist").select2({ placeholder: '--- Select Syllabus Type ---' });
            $("#SyllabusClasses").select2({ placeholder: '--- Select class ---' });
        ...
        $("#export_sort_session").change(function(){
            ...
            if(export_type != '' && export_sort != ''){
                ...
                if(export_sort == 'A0' && export_type == 1){
                    ...
                    $('#gender_session,#date_session').hide();
                    $('#dmy_session').hide();
        ...
        $("#export_datetype").change(function(){
            ...
            if(datetype == ''){
                ...
                if(datetype == 00){
                    ...
                    $('#date_session,#gender_session').show();
