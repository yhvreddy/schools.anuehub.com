...
<div id="content" class="content">
	...
	<!-- end breadcrumb -->
	<!-- begin page-header -->
	<h1 class="page-header">Admission Details<small></small></h1>
	<!-- end page-header -->
	<!-- Start Page Content -->
	<div class="row">
		<div class="col-12">
			<div class="panel panel-inverse">
				<div class="panel-heading">
					<div class="panel-heading-btn">
						...
						<a href="<?=base_url('dashboard/admissions/admissionslist')?>" class="pull-right btn btn-success btn-xs"><i class="fa fa-list"></i> Admissions list</a>
				...
				<div class="panel-body">
					<div class="col-md-12">
						...
						<div class="row">
							...
							<h4 class="text-capitalize text-success">FEE DETAILS</h4>
							<div class="col-md-12">
							<div class="row">
								...
								foreach ($fee as $key => $feelist){ ?>
									<div class="col-md-3">
										<div class="row">
											<span class="col-md-12"><label class="font-bold"><?php if($key == 'service'){ echo 'Hostel / Bus'; }else{ echo $key; } ?> :</label> <?php echo $feelist.'/-'; ?></span>
										</div>
									</div>
								<?php } ?>
								<div class="col-md-3">
									<div class="row">
										<span class="col-md-12"><label class="font-bold">Totalfee :</label> <?php echo $stdinfo->totalfee.'/-'; ?></span>
									</div>
								</div>
							</div>
						</div>
