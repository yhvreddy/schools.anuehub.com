        ...
        <div class="col-12">
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    <div class="col-md-12">
                        <form method="post" enctype="multipart/form-data" action="<?=base_url('dashboard/notice/savenotice')?>">
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="row">
                                                <div class="col-md-4 form-group">
                                                    ...
                                                    <input type="text" name="noticedate" value="<?= date('d/m/Y') ?>" class="mydatepicker form-control" placeholder="Pick Notice date" required readonly>
                                                </div>
                                                <div class="col-md-4 form-group">
                                                    <label>Pick Publish Date</label>
                                                    <input type="text" name="noticepublishdate" value="<?= date('d/m/Y') ?>" required class="mydatepicker form-control" placeholder="Pick Publish date">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12" style="margin-top: 10px;">
                                            ...
                                            <div class="form-group">
                                                <input type="text" class="form-control" placeholder="Title of the Notice" name="noticetitle" required>
                                            </div>
                                        </div>
                                                ...
                                                foreach ($source as $sourcename){ if($sourcename->type == 'staff' || $sourcename->type == 'worker' || $sourcename->type == 'office' || $sourcename->type == 'student'){?>
                                                    <div class="col-md-6 form-group">
                                                        <div class="checkbox checkbox-css">
                                                            <input type="checkbox" id="cssCheckbox1<?=$sourcename->id?>" name="noticeto[]" value="<?=$sourcename->shortname?>" />
