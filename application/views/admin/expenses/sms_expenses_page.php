        ...
        <div class="col-12">
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    <form class="col-md-12" action="<?=base_url('dashboard/expenses/expenseSavedata')?>" id="saveexpensesData" name="saveexpenses" method="post" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <select autofocus="" id="exp_head_id" name="exp_head_id" class="form-control select2" autocomplete="off" required>
                                    ...
                                    <?php $i = 1; foreach ($expenseshead as $expense){ ?>
                                        <option value="<?=$expense->sno?>"><?=$expense->name?></option>
                                    <?php } ?>
                                </select>
                            </div>
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <input id="expensesName" name="exp_name" placeholder="Expenses Name" type="text" class="form-control" value="">
                                <span class="text-danger"></span>
                            </div>

                            <div class="form-group col-md-2">
                                <label for="exampleInputEmail1">Invoice Number <small class="text-danger">*</small></label>
                                <input id="invoice_no" required name="invoice_no" placeholder="Invoice id" type="text" class="form-control" value="">
                                <span class="text-danger"></span>
                            </div>

                            <div class="form-group col-md-2">
                                <label for="exampleInputEmail1">Date <small class="text-danger">*</small></label>
                                <input id="expensesDate" name="exp_date" placeholder="Date" type="text" class="form-control mydatepicker" value="<?=date('m/d/Y');?>" readonly="readonly" autocomplete="off">
                                <span class="text-danger"></span>
                            </div>

                            <div class="form-group col-md-2">
                                <label for="exampleInputEmail1">Amount <small class="text-danger">*</small></label>
                                <input id="expensesAmount" name="exp_amount" required placeholder="Expenses Amount" type="text" class="form-control">
                                <span class="text-danger"></span>
                            </div>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <textarea class="form-control" id="exp_description" name="description" placeholder="Description" rows="3"></textarea>
                                <span class="text-danger"></span>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="radio radio-css radio-inline">
                                            <input type="radio" id="inlineCssRadio1_<?='offline'?>" name="payment_status" value="pending" />
                                            <label for="inlineCssRadio1_<?='offline'?>">Pending </label>
                                        </div>
                                        <div class="radio radio-css radio-inline">
                                            <input type="radio" id="inlineCssRadio1_<?='online'?>" name="payment_status" value="complete" />
