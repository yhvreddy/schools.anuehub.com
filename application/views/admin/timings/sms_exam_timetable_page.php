		...
		<div class="col-md-4 col-sm-12 col-xs-12">
			<div class="panel panel-inverse">
				<div class="panel-heading">
					...
					<h4 class="panel-title">Examination Slabs List</h4>
				</div>
				<div class="panel-body">
					...
					<?php
						...
						if(count($slabslist) != 0){ ?>
								...
								<table class="table table-bordered table-striped">
									...
									<?php $i = 1; foreach ($slabslist as $value){ ?>
										<tr>
											...
											<td>&nbsp;
												<a href="<?=base_url('dashboard/timings/exam/deleteslabs/'.$value->sno.'/'.$value->branch_id.'/'.$value->school_id.'/'.$value->exam_id)?>" onclick="return confirm('Are you sure want to delete <?=$value->slab_name?> examination slab..?')"><i class="fa fa-trash-o fa-dx"></i></a>
											</td>
										</tr>
									<?php } ?>
									</tbody>
							...
							<p>
								<span class="text-warning font-weight-bold">Note : </span> You can delete examination slab then the related data will also deleted..! & Also you can not edit slab once you created it.
							</p>
						<?php }else{
                                ...
                                <?php $i = 1; foreach($timingslist as $timings){
									...
									<tr class="text-uppercase text-info">
										...
										<td align="center">
											...
											<a href="<?=base_url('dashboard/timings/exam/deleteexamtimings/'.$timings->sno.'/'.$timings->branch_id.'/'.$timings->school_id)?>" onclick="return confirm('Are you want to delete <?=$slab[0]->slab_name?> Examination Timetable..?');"><i class="fa fa-trash-o fa-dx"></i></a>&nbsp;
										</td>
									</tr>
								<?php } ?>
                                </tbody>
